...
The print views (loan statement, customer statement, payment history) read these exact
field names. Renaming one without updating the frontend would silently print zeros, so
